    ...
    <>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .form-label { display: block; font-size: 14px; font-weight: 600; color: #0f172a; margin-bottom: 8px; }
        ...
        .form-input {
          ...
          border-radius: 8px; color: #0f172a; outline: none; transition: all 0.2s;
        }
        .form-input:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,0.1); background: white; }
        .form-input:disabled { opacity: 0.6; cursor: not-allowed; }
        .form-input.otp-input { letter-spacing: 8px; font-size: 18px; font-weight: 600; text-align: center; padding-left: 16px; }
        .recaptcha-wrapper { margin-bottom: 20px; display: flex; justify-content: center; }
        .btn {
        ...
        .btn-back {
          background: none; border: none; padding: 8px 12px; margin-bottom: 16px;
        ...
        .divider-text { display: inline-block; padding: 0 16px; background: white; font-size: 13px; color: #64748b; position: relative; z-index: 1; }
        .auth-footer { text-align: center; margin-top: 24px; padding-top: 24px; border-top: 1px solid #e2e8f0; }
        .auth-footer-text { font-size: 14px; color: #64748b; }
        .auth-link { color: #3b82f6; font-weight: 600; text-decoration: none; }
        .auth-link:hover { color: #2563eb; }
        .spinner { animation: spin 1s linear infinite; }
        @keyframes spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
        @media (max-width: 480px) { .auth-container { padding: 32px 24px; } .auth-title { font-size: 22px; } }
      `}</style>
