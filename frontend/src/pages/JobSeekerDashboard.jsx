    ...
    <>
      ...
      <div className="dashboard-wrapper">
        <div className="dashboard-container">
          ...
          {/* Ad Banner 1 - Featured Opportunity */}
          <div className="ad-banner">
            <div className="ad-title">
              <Sparkles size={20} />
              Featured Green Energy Opportunity
            </div>
            <div className="ad-text">
              Join India's leading solar energy companies - Upload your resume today and get hired faster!
            </div>
          </div>
          ...
          {/* Ad Banner 2 - Premium */}
          <div className="ad-banner ad-banner-premium">
            <div className="ad-title ad-title-blue">
              <TrendingUp size={20} />
              Premium Job Opportunities
            </div>
            <div className="ad-text ad-text-blue">
              Upgrade your profile to get priority access to exclusive green energy roles from top companies
            </div>
          </div>
