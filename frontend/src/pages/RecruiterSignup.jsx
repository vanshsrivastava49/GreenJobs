  ...
  return (
    <>
      <style>{`
        ...
        /* ── LEFT — form (mirrors RecruiterLogin .rec-left) ── */
        .recs-left {
          flex: 1; min-width: 0;
        ...
        /* Role chips */
        .recs-role-row { display: flex; gap: 6px; flex-wrap: wrap; margin-bottom: 28px; }
        .recs-chip {
        ...
        .recs-chip:hover { border-color: #10b981; color: #16a34a; }
        .recs-chip.active { border-color: #10b981; color: #15803d; background: #f0fdf4; }
        ...
        /* ══ OTP grid fix ══ */
        .recs-form-box .otp-row,
        .recs-form-box [class*="otp-row"],
        .recs-form-box [class*="otp_row"] {
          display: grid !important;
          grid-template-columns: repeat(6, 1fr) !important;
          gap: 8px !important; width: 100% !important;
        }
        .recs-form-box .otp-row input,
        .recs-form-box [class*="otp-row"] input,
        .recs-form-box [class*="otp_row"] input {
          width: 100% !important; flex: unset !important;
          aspect-ratio: 1/1 !important; max-height: 60px !important;
          padding: 0 !important; box-sizing: border-box !important;
        }

        /* Child form overrides — green theme */
        .recs-form-box input {
        ...
        .recs-form-box button[type="submit"] {
        ...
        .recs-form-box button[type="submit"]:hover:not(:disabled) {
          background: #14532d !important;
          transform: translateY(-1px) !important;
          box-shadow: 0 4px 12px rgba(5,46,22,0.25) !important;
        }
        .recs-form-box input[maxLength="1"],
        .recs-form-box input[maxlength="1"] {
        ...
        .recs-form-box input[maxLength="1"]:focus,
        .recs-form-box input[maxlength="1"]:focus {
          background: #f0fdf4 !important;
          border-color: #10b981 !important;
        }

        /* ── RIGHT — brand panel (mirrors RecruiterLogin .rec-right, green palette) ── */
        .recs-right {
        ...
        /* Dot pattern like JobSeekerSignup circles — subtle radial dots */
        .recs-right-pattern {
          position: absolute; inset: 0; pointer-events: none;
          background-image: radial-gradient(circle, rgba(110,231,183,0.12) 1px, transparent 1px);
        ...
        /* Decorative circles like JobSeekerSignup left panel */
        ...
        .recs-right-desc {
          ...
          line-height: 1.8; margin-bottom: 40px; max-width: 320px;
        }
        ...
        .recs-feature-icon {
          ...
          background: rgba(16,185,129,0.15); border: 1px solid rgba(110,231,183,0.25);
        ...
        /* Free badge — like BusinessSignup */
        .recs-free-badge {
        ...
        <div className="recs-left">
          <div className="recs-form-box">
            ...
            {step === "signup" ? (
              ...
              <>
                <button className="recs-back" type="button" onClick={handleBack}>
        ...
        <div className="recs-right">
          ...
          <div className="recs-right-content">
            ...
            <h2 className="recs-right-title">
              Hire <span>smarter</span> in green energy
            </h2>
            <p className="recs-right-desc">
              Post jobs, review applications, and build your renewable energy team
              with India's leading green hiring platform.
            </p>

            <div className="recs-features">
              <div className="recs-feature">
                <div className="recs-feature-icon"><Users size={16} color="#6ee7b7" /></div>
                <div>
                  <div className="recs-feature-title">Verified Talent Pool</div>
                  <div className="recs-feature-desc">Access pre-screened green energy professionals</div>
                </div>
              </div>
              <div className="recs-feature">
                <div className="recs-feature-icon"><Zap size={16} color="#6ee7b7" /></div>
                <div>
                  <div className="recs-feature-title">Fast Hiring</div>
                  <div className="recs-feature-desc">Post a job and get applications within 24 hours</div>
                </div>
              </div>
              <div className="recs-feature">
                <div className="recs-feature-icon"><Target size={16} color="#6ee7b7" /></div>
                <div>
                  <div className="recs-feature-title">Targeted Reach</div>
                  <div className="recs-feature-desc">Connect with candidates matched to your roles</div>
                </div>
              </div>
            </div>
