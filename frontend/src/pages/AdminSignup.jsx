    ...
    <>
      <style>{`
        ...
        .adms-card {
          ...
          animation: admsIn 0.4s ease both; backdrop-filter: blur(8px);
        }
        ...
        .adms-chip:hover { border-color: rgba(110,231,183,0.4); color: #6ee7b7; }
        .adms-chip.active { border-color: #6ee7b7; color: #6ee7b7; background: rgba(16,185,129,0.1); }
        ...
        /* Warning gate */
        .adms-gate {
          background: rgba(16,185,129,0.05); border: 1px solid rgba(110,231,183,0.2);
          border-radius: 8px; padding: 18px 20px; margin-bottom: 24px;
        }
        .adms-gate-title {
          font-size: 12px; font-weight: 700; color: #6ee7b7; margin-bottom: 8px;
        ...
        .adms-gate-checkbox {
          width: 16px; height: 16px; border: 1px solid rgba(255,255,255,0.15); border-radius: 3px;
        ...
        .adms-card label {
          ...
          color: rgba(255,255,255,0.4) !important; letter-spacing: 0.08em !important; text-transform: uppercase !important;
        }
        ...
        .adms-card button[type="submit"]:hover:not(:disabled) {
          background: linear-gradient(135deg, #166534, #15803d) !important;
          transform: translateY(-1px) !important;
          box-shadow: 0 4px 12px rgba(5,46,22,0.4) !important;
        }
        .adms-card input[maxLength="1"],
        .adms-card input[maxlength="1"] {
          font-size: 22px !important; font-weight: 800 !important;
          text-align: center !important; color: #6ee7b7 !important;
        }
        .adms-card input[maxLength="1"]:focus,
        .adms-card input[maxlength="1"]:focus {
          background: rgba(16,185,129,0.08) !important; border-color: #10b981 !important;
        }
